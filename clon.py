...
# Original written By ilhamRD

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'ham'

__copyright = 'All rights reserved . Copyright  ilham Rekod'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open wa.me/6285773092759')
        ...
        os.system('xdg-open wa.me/625773092759')
...
/Cuman perikod doang gak lebih mweheheheh xontol <::::::::::::::::[]
